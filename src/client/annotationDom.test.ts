...
import { decorateAnnotations, setHtmlAnnotationMode } from "./annotations";
...
describe("paintMarginNotes", () => {
  ...
  it("decorateAnnotations in margin mode lays notes into the gutter", () => {
    ...
    setHtmlAnnotationMode("floating"); // restore for other tests
  });
});
