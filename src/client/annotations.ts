...
let htmlMode: HtmlAnnotationMode = readStoredMode();

function readStoredMode(): HtmlAnnotationMode {
  try {
...
export function getHtmlAnnotationMode(): HtmlAnnotationMode {
  return htmlMode;
}

export function setHtmlAnnotationMode(mode: HtmlAnnotationMode): void {
  htmlMode = mode;
  try {
