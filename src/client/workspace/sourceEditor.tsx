...
//   html     → a plain source editor + sandboxed live preview (rich editing = SRC-4).
...
export function AuthoredSourceView({ source, reader }: { source: SourceRecord; reader: ReactNode }) {
  ...
  const dirty = loaded && (draft !== savedContent || titleDraft !== source.title);
    ...
    <div className="source-editor-host" data-mode={mode}>
      ...
      {mode === "read" ? (
        ...
        <div className="source-editor-html">
          <div className="source-editor-html-hint">{t(m.htmlEditorHint)}</div>
          <div className="source-editor-split">
            <textarea
              ref={textareaRef}
