...
- **SPEECH-1 ✅ 朗读** (edge-tts lane shipped, SPEECH-1-001) → **SPEECH-2** 语音输入 (three lanes) → **SPEECH-3** 注音 (speech-and-young-learners.md; 低龄复习环 = the payoff).
